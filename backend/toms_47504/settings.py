"""
Django settings for toms_47504 project.
...
WSGI_APPLICATION = 'toms_47504.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "toms_47504 API",
    "DESCRIPTION": "API documentation for toms_47504 App",
    "VERSION": "v1",
}
